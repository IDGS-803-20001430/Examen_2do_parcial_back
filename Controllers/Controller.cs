...
using static BazarUniversal_Backend.Controllers.ControllerJ;

namespace BazarUniversal_Backend.Controllers
{
    [Route("api/AppTienda")]
    [ApiController]
    public class ControllerE : Controller
    {
        private readonly BazarUniversalContext _baseDatos;

        public ControllerE(BazarUniversalContext baseDatos)
        {
